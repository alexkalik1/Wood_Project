...
class EstimatesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create estimate" do
    assert_difference('Estimate.count') do
      post estimates_url, params: { estimate: { materials: @estimate.materials, project_id: @estimate.project_id, total_price: @estimate.total_price } }
    end
  ...
  test "should update estimate" do
    patch estimate_url(@estimate), params: { estimate: { materials: @estimate.materials, project_id: @estimate.project_id, total_price: @estimate.total_price } }
